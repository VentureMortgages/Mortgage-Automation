...
| 26. Conversational Filing Assistant | 1/3 | In Progress|  | - |
...
Plans:
- [x] 25-01-PLAN.md -- AI forwarding note parser + intake worker per-attachment assignment + Wong-Ranasinghe data fix
